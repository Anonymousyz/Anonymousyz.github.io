...
export const featuredCase = {
  index: '01',
  title: '工业绿色微电网评价软件',
  summary: '评价标准原来分散在政策文件、指标和报告中。软件把这些内容写成数据字段、计算规则和报告模板。我参与前期研究、产品设计、测试和交付检查；已验证和仍待专业复核的部分分别记录。',
...
export const projects = [
  {
    ...
    summary: '系统按分析师处理资料、Excel 和报告的顺序设计，包含数据导入、专业计算、审核、报告生成、权限和日志。',
    role: '我组织需求梳理，参与工作流程设计、架构选择、测试和部署验证。',
    deliveryPath: '资料与 Excel → 数据导入 → 专业计算 → 审核 → 报告生成',
    publicScope: ['工作流结构', '系统范围', '测试与交付范围'],
    evidence: 'sanitized',
    problem: '分析师原来在分散的资料、Excel 和人工报告之间反复切换。团队需要一条工作流程，能追查数据来路，也能复核计算过程。',
    decisions: [
  ...
  },
  {
    ...
    title: '口腔小程序项目',
    pillar: '从技术到应用',
    summary: '项目要让家长、儿童和门诊协同工作，先理清授权关系，再把检查报告、预约、随访和后台处理接起来。',
...
export const tools = [
  ...
  },
  {
    ...
    summary: '从项目材料中列出上线前检查项和暂缓条件，帮助团队分清原型演示与真实业务使用。',
  ...
  },
  {
    ...
    summary: '按评估、可观测性、护栏、治理、安全和部署整理的公开资料清单。',
