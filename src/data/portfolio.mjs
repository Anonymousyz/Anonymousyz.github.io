...
export const featuredCase = {
  index: '01',
  title: '工业绿色微电网评价软件',
  summary: '评价标准原来分散在政策文件、指标和报告中。我把它们整理成数据字段、计算规则和报告模板，参与前期研究、产品设计、测试和交付检查。本页同时说明哪些已验证，哪些仍待专业复核。',
...
export const workLoop = [
  ...
  { index: '04', title: '验证交付', description: '完成测试和复核，检查部署与回退安排。' },
  { index: '05', title: '整理留存', description: '把反复使用、已经验证的做法留下来，整理成工具、模板和记录。' }
];
...
export const projects = [
  {
    ...
    summary: '系统照着分析师处理资料、Excel 和报告的顺序来设计，包含数据导入、专业计算、审核、报告生成、权限和日志。',
    role: '我组织需求梳理，参与工作流程设计、架构选择、测试和部署验证。',
    deliveryPath: '资料与 Excel → 数据导入 → 专业计算 → 审核 → 报告生成',
    publicScope: ['工作流结构', '系统范围', '测试与交付范围'],
    evidence: 'sanitized',
    problem: '分析师原来要在分散的资料、Excel 和人工报告之间反复切换。团队需要一条工作流程，既能追查数据来路，也能复核计算过程。',
    decisions: [
  ...
  },
  {
    ...
    title: '工业技术改造投资管理平台项目',
    pillar: '从分析到决策 · 从技术到应用',
    summary: '申报阶段，要把政策要求落实到项目方案、建设任务和预算。进入建设阶段，再把项目、角色和审批关系整理成台账、权限、状态和工作台。',
    role: '我参与申报论证、预算和建设任务设计。进入建设阶段后，我继续梳理材料，参与产品定义、流程和权限设计、功能检查与测试。',
    deliveryPath: '政策与产业问题 → 项目方案与任务 → 角色与对象 → 审批流程 → 权限、状态与工作台',
    publicScope: ['方案结构', '对象与角色设计', '审批流程', '权限与测试范围'],
    evidence: 'sanitized',
    problem: '申报时，政策目标要落到可以建设、可以验收的任务上；建设时，材料里的角色、流程和监管要求也要落实到系统里。',
    decisions: [
    ...
    prototypeShowcase: {
      status: '公共门户首页 · 界面快照',
      intro: '用一张脱敏主页，说明政策、项目与服务入口如何面向使用者安排。',
      images: [
        {
          ...
          label: '公共门户首页',
          explanation: '政策信息、项目入口和服务指南集中在公共门户首页，方便使用者先了解事项，再进入办理。',
  ...
  },
  {
    ...
    title: '口腔小程序项目',
    pillar: '从技术到应用',
    summary: '项目服务家长、儿童和门诊之间的协同。先理清授权关系，再把检查报告、预约、随访和后台处理接起来。',
    role: '我参与业务梳理、产品流程设计和系统检查，并准备受控演示。',
...
export const tools = [
  ...
  },
  {
    ...
    summary: '根据项目材料列出上线前检查项和暂缓条件，帮助团队分清原型演示和真实业务使用。',
