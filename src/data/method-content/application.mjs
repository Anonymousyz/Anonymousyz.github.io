export const applicationMethods = [
  {
    ...
    article: {
      ...
      eyebrow: '从技术到应用',
      lead: '做产品，先要说明准备解决什么问题、为什么值得投入、准备用什么办法验证。问题成立后，我再把使用者、业务对象、流程、权限和验收条件交给工程设计。',
      map: {
        label: '从判断到工程设计',
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '还要记下现在怎样解决：用表格、聊天、电话、纸面登记，还是靠人协调。新产品不仅要说明省下什么，也要估计它带来的学习和切换成本。',
          ],
        },
        {
          id: 'objects-flow',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '证据还不够，就把判断写成假设，并注明下一步要观察什么。问题、使用者和预期价值已经足以支持当前决定后，再比较解决方案。',
          ],
        },
        {
          ...
          heading: '用小规模试验验证方案',
          paragraphs: [
            '最小可行产品（MVP）先验证风险最高的假设。可以用原型核对对问题和流程的理解，也可以暂时保留人工环节，先看数据和判断是否有用。',
  ...
  },
  {
    ...
    article: {
      title: '视觉｜重点 · 秩序 · 取舍',
      eyebrow: '从技术到应用',
      lead: '视觉设计首先要让人找到重点、看懂关系、分清状态、完成操作。先理清信息和任务，再统一字号、颜色、间距和组件；能删去的装饰尽量删去，必要的说明和反馈不能少。',
      map: {
        label: '三个取舍',
      ...
      sections: [
        ...
        },
        {
          ...
          heading: '在信息量和留白之间取舍',
          paragraphs: [
            '信息太少，读者会失去上下文；装饰太多，重点又会被淹没。页面既要让人看清重点、关系和状态，也要避免无关形式打断阅读。',
  ...
  },
  {
    ...
    article: {
      title: '工程｜稳定 · 维护 · 交付',
      eyebrow: '从技术到应用',
      lead: '工程工作要保证系统做得稳、有人维护、能够交接。业务规则需要落实到数据、状态和权限；测试、发布和运行记录也要和具体版本、环境、责任人对应。',
      map: {
        label: '从产品判断到运行维护',
        steps: [
          '经营判断',
      ...
      sections: [
        {
          ...
          heading: '让业务规则在系统里有落点',
          paragraphs: [
            '工程设计从已经确认的业务对象、字段、状态、角色、规则和异常情况开始，再分别落实到数据模型、状态机、权限矩阵、校验规则和接口约定中。',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '四个方面要互相对得上。业务对象在数据中找不到位置、模块职责没有运行范围，或所选技术超过团队的维护能力，问题迟早会在交付时暴露。',
          ],
        },
        {
          id: 'minimum-docs',
        ...
        },
        {
          ...
          paragraphs: [
            '同一个人可以兼任产品、架构、开发、测试和运行，但每次检查都要说明他此刻承担哪项责任。这样才看得出“功能已经做完”和“功能已经验证”之间还有没有空档。',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '生成的代码仍要经过代码审查、自动测试和实际运行检查。来源、行为或安全影响无法确认的改动不能进入交付版本，最终责任由项目成员承担。',
          ],
        },
        {
          id: 'assets',
