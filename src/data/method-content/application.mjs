export const applicationMethods = [
  {
    ...
    article: {
      ...
      eyebrow: '从技术到应用',
      lead: '产品工作先回答一件事：谁遇到了什么困难，现有办法为什么不够，值不值得投入。问题查清后，用小规模试验验证方案；确认的角色、对象、流程、异常和验收条件，再交给工程。',
      map: {
        label: '从判断到工程设计',
  ...
  },
  {
    ...
    article: {
      title: '视觉｜重点 · 秩序 · 取舍',
      eyebrow: '从技术到应用',
      lead: '视觉设计要让人找到重点、看懂关系、分清状态，也知道下一步怎么做。信息和任务理顺了，字号、颜色、间距和组件才有依据；装饰可以少，必要的说明和反馈不能少。',
      map: {
        label: '三个取舍',
  ...
  },
  {
    ...
    article: {
      title: '工程｜稳定 · 维护 · 交付',
      eyebrow: '从技术到应用',
      lead: '交付一套系统，不只看代码能不能运行，还要看后来有没有人能维护、接手。业务规则要落到数据、状态和权限上；测试、发布和运行记录要对应具体版本、环境和负责人。',
      map: {
        label: '从产品判断到运行维护',
        steps: [
          '立项判断',
