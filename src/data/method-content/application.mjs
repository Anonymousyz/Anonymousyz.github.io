export const applicationMethods = [
  {
    ...
    article: {
      ...
      eyebrow: '从技术到应用',
      lead: '做产品，先从一个具体问题开始：谁遇到了什么困难，现有办法为什么不够，这件事值不值得投入。问题查清后，用小规模试验验证方案，再把角色、对象、流程、异常和验收条件交给工程。',
      map: {
        label: '从判断到工程设计',
  ...
  },
  {
    ...
    article: {
      title: '视觉｜重点 · 秩序 · 取舍',
      eyebrow: '从技术到应用',
      lead: '视觉设计先让人找到重点、看懂关系、分清状态、完成操作。信息和任务理顺后，再统一字号、颜色、间距和组件；装饰可以少，必要的说明和反馈不能少。',
      map: {
        label: '三个取舍',
  ...
  },
  {
    ...
    article: {
      title: '工程｜稳定 · 维护 · 交付',
      eyebrow: '从技术到应用',
      lead: '交付一套系统，代码要能运行，后续也要有人维护、有人接手。业务规则要写进数据、状态和权限；测试、发布和运行记录要对应具体版本、环境和负责人。',
      map: {
        label: '从产品判断到运行维护',
        steps: [
          '立项判断',
